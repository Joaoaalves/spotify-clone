...
function Nav() {
  return (
    <nav className="bg-container rounded-lg w-full">
...
function Library() {
  return (
    <div className="bg-container rounded-lg w-full">
      <LibraryHeader />
      <LibraryTags />
      <ScrollArea className="h-[75%] 2xl:h-[85%]">
        <LibrarySearch />
        <LibraryLists />
      </ScrollArea>
    </div>
...
function LibraryTags() {
  return (
    <ul className="w-full flex items-center justify-start gap-x-2 px-4 my-2">
...
function LibraryTag({ text }) {
  return (
    <li className="py-1.5 px-3 text-text bg-muted rounded-full text-sm flex flex-col font-normal hover:bg-hover cursor-pointer transition duration-300 ease-in-out">
      {text}
    </li>
  );
}
...
function LibrarySearch() {
  return (
    <div className="flex items-center justify-between gap-x-2 py-5 px-5 w-full text-secondary">
      <SearchInput />
...
function LibraryLists() {
  return (
    <ul className="w-full flex flex-col items-center justify-center py-1 rounded-lg">
      <LibraryListItem
        icon={<LuLibrary className="text-3xl" />}
        title="Made For You"
        link="/made-for-you"
      />
      <LibraryListItem
...
function LibraryListItem({ icon, title, link }) {
  return (
    <li className="flex items-center justify-start gap-x-4 py-3 px-5 w-full text-secondary">
